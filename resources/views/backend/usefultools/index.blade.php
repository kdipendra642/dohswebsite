            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="useful-table">
                            <thead>
                            <tr>
                                <th>#</th>
                            ...
                            <tbody>
                                @foreach ($usefulTools as $usefultool)
   
                                {{-- modal --}}
                                <div class="modal fade" id="exampleModalCenter{{$usefultool->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('usefultools.destroy', $usefultool->id) }}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
...
jQuery(document).ready(function($) {
    $('#useful-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('usefultools.data') }}",
            type: "GET",
